        ...
        <ul class="nav" id="side-menu">
            ...
            <li class="active">
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li class="active"><a href="export-mail.html">Xuất mail</a></li>
                    <li><a href="send-mail.html">Gửi mail</a></li>
                </ul>
            </li>
        </ul>
         ...
         <div class="row">
            <div class="col-md-12">
                <div class="hpanel hgreen">
                    <div class="panel-heading hbuilt">Chọn khóa học
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                               <form action="" class="form-horizontal">
                                   <div class="form-group">
                                        <label for="message" class="col-md-2 control-label">Chọn khóa học</label>
                                        <div class="col-md-10">
